            ...
            if (args.ElementAtOrDefault<string>(0) != null)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        hTMLBody[3] = $@"<p>Сообщение IPS\IDS: {split[13]}</p><br><br><p>Согласно данным {device}, срабатывания сигнатур к дургим хостам <font color=""red"">не выявлено\выявлено к хостам</font>:</p>";
